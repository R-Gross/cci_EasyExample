...
const unsigned char ISO_OP_MEMORY_CLASS isoOP_MyProject1[] = {
	...
	ID(DataMask_Home), TYPEID_DATAMASK, COLOR(230), ID(SoftKeyMask_Home), 10, 0, 
		...
		XYREF(Button_Minus, 208, 423),
		XYREF(Button_Seite1, 182, 186),
	ID(DataMask_Seite1), TYPEID_DATAMASK, COLOR_SILVER, ID(ID_NULL), 1, 0, 
	...
	ID(SoftKey_Minus), TYPEID_SOFTKEY, COLOR(187), 1, 1, 0, 
		XYREF(OutputString_11007, 23, 23),
	...
	ID(Button_Minus), TYPEID_BUTTON, WORD(94), WORD(45), 187, 144, 1, 0, 1, 0, 
		XYREF(OutputString_Minus, -1, -2),
	ID(Button_Seite1), TYPEID_BUTTON, WORD(101), WORD(35), 249, 249, 1, 0, 1, 1, 
		XYREF(OutputString_11009, -4, -1),
	...
	ID(InputNumber_Gesamtzaehler), TYPEID_INNUM, WORD(144), WORD(32), COLOR_LIME, ID(FontAttributes_Default), 0, 
	...
	ID(OutputString_Reset_Tageszaehler), TYPEID_OUTSTR, WORD(80), WORD(40), COLOR_WHITE, ID(FontAttributes_Button), 3,
		...
		'T', 'a', 'g', 'e', 's', 0,
	ID(OutputString_Minus), TYPEID_OUTSTR, WORD(88), WORD(40), COLOR_WHITE, ID(FontAttributes_23000), 1,
		ID(ID_NULL), 1, WORD(4), '-', '-', ' ', ' ', 0,
	ID(OutputString_11007), TYPEID_OUTSTR, WORD(58), WORD(53), COLOR_WHITE, ID(FontAttributes_Button), 1,
		ID(ID_NULL), 0, WORD(4), '-', '-', ' ', ' ', 0,
	ID(OutputString_11008), TYPEID_OUTSTR, WORD(161), WORD(29), COLOR_WHITE, ID(FontAttributes_23000), 1,
		ID(ID_NULL), 1, WORD(4), 'H', 'o', 'm', 'e', 0,
	ID(OutputString_11009), TYPEID_OUTSTR, WORD(101), WORD(29), COLOR_WHITE, ID(FontAttributes_23000), 1,
